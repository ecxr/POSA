...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        SimpleSemaphore pingSem = new SimpleSemaphore(mMaxLoopIterations, daemon);
        SimpleSemaphore pongSem = new SimpleSemaphore(mMaxLoopIterations, daemon);
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	pingSem=semaphoreOne;
        	pongSem=semaphoreTwo;
        	pingStr=stringToPrint;
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(finishString, pingSem, pongSem, mMaxIterations/*
                                                          * TODO - You fill in
                                                          * here
                                                          */
        		);
