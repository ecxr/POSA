...
public class SimpleSemaphore {
     ...
     */
    // TODO - you fill in here
	private Condition mPermitsAvailableCondition;
    ...
    public SimpleSemaphore(int permits, boolean fair) {
    	...
    	mPermitsAvailableCondition = lock.newCondition();
    }
    ...
    public void acquire() throws InterruptedException {
    	...
    	try {
    		while (mAvailablePermits <= 0)
    			mPermitsAvailableCondition.await();
    		mAvailablePermits--;
    	} finally {
    		lock.unlock();
    	}
    ...
    public void acquireUninterruptibly() {
    	...
    	try {
    		while (mAvailablePermits <= 0)
    			mPermitsAvailableCondition.awaitUninterruptibly();
    		mAvailablePermits--;
    	} finally {
    		lock.unlock();
    	}
    ...
    public void release() {
    	...
    	try {
    		...
    		if (mAvailablePermits > 0) 
    			mPermitsAvailableCondition.signal();
    	} finally {
    		lock.unlock();
    	}
    }
