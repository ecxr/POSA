    ...
    public void runService(View view) {
        ...
        case R.id.bound_sync_button:
        	...
        	try {
				...
				this.displayBitmap(path);
			} catch (RemoteException e) {
				Log.e(TAG, "Error downloading image: " + e.getStackTrace().toString());
			}
            break;
        ...
        case R.id.bound_async_button:
            ...
            // callback.
        	try {
				mDownloadRequest.downloadImage(uri, DownloadActivity.this.getDownloadCallback()	);
			} catch (RemoteException e) {
				Log.e(TAG, "Error downloading image: " + e.getStackTrace().toString());
			}
            break;
