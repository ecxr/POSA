...
{	
    ...
    public void begin()
    {
    	...
    	mLatch = new CountDownLatch(Options.instance().maxTurns());
    }
    ...
    public void print(final String outputString)
    {
    	...
    	// Post the runnable to the UI looper thread
    ...
    public void awaitDone()
    {
    	...
    	try{
    		...
    		this.errorLog("AndroidPlatformStrategyInstance: ",
    				"Barrier synchronization interrupted.");
    	}
